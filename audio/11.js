  ...
  })()(
    {
        ...
        function (require, module, exports) {
          ...
          function _regeneratorRuntime() {
            ...
            function maybeInvokeDelegate(e, r) {
              ...
              return a
                ? a.done
                  ? ((r[e.resultName] = a.value), (r.next = e.nextLoc), "return" !== r.method && ((r.method = "next"), (r.arg = t)), (r.delegate = null), y)
                  : a
            ...
            return _createClass(FileReader, [
              {
                key: "openFile",
                value: (function () {
                  var _openFile = _asyncToGenerator(
                    /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(input, chunkSize) {
                      var blob;
                            ...
                            switch ((_context.prev = _context.next)) {
                              ...
                              case 13:
                                ...
                                return _context.abrupt(
                                  "return",
                                  Promise.reject(new Error("cannot create source for stream without a finite value for the `chunkSize` option"))
                                );
                              case 17:
                              ...
                              case 18:
                                return _context.abrupt(
                                  "return",
                                  Promise.reject(new Error("source object may only be an instance of File, Blob, or Reader in this environment"))
                                );
                              case 19:
                              case "end":
      ...
      4: [
        function (require, module, exports) {
          ...
          var defaultOptions = (exports.defaultOptions = _objectSpread(
            _objectSpread({}, _upload["default"].defaultOptions),
            {},
            {
          ...
          var isSupported = (exports.isSupported =
            typeof XMLHttpRequest === "function" && typeof Blob === "function" && typeof Blob.prototype.slice === "function");
        },
        {
          "../error.js": 12,
          "../logger.js": 13,
        ...
        function (require, module, exports) {
          ...
          var isCordova = function isCordova() {
            return (
              ...
              (typeof window.PhoneGap !== "undefined" || typeof window.Cordova !== "undefined" || typeof window.cordova !== "undefined")
            );
          };
      ...
      15: [
        function (require, module, exports) {
              ...
              [
                ...
                },
                {
                  ...
                  value: function _startParallelUpload() {
                    ...
                    var parts =
                      (_this$options$paralle = this.options.parallelUploadBoundaries) !== null && _this$options$paralle !== void 0
                        ? _this$options$paralle
                          ...
                          var options = _objectSpread(
                            ...
                            {},
                            {
                              ...
                              onUploadUrlAvailable: function onUploadUrlAvailable() {
                                ...
                                if (
                                  _this3._parallelUploadUrls.filter(function (u) {
                                    return Boolean(u);
                                  }).length === parts.length
                                ) {
                    ...
                    return this._source.slice(start, end).then(function (_ref2) {
                      ...
                      if (!_this9.options.uploadLengthDeferred && done && newSize !== _this9._size) {
                        return Promise.reject(
                          new Error(
                            "upload was configured with a size of ".concat(_this9._size, " bytes, but the source is done after ").concat(newSize, " bytes")
                          )
                        );
                      }
                      if (value === null) {
          ...
          function _sendRequest2() {
            _sendRequest2 = _asyncToGenerator(
              /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(req, body, options) {
                var res;
